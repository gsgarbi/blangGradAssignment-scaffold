...
class TestBipartiteMatching {
  val static int size = 5 //original: 5
  val static UniformBipartiteMatching unifMatchingModel = 
  new UniformBipartiteMatching.Builder().setMatching(new BipartiteMatching(size)).build
